...
const VK = ({color}) => (
    <svg style={{fill:color}} xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24" height="24" viewBox="0 0 50 50">
  ...
  const socialLinks = {
    telegram: 'https://t.me/ksu_kaluga',
    instagram: 'https://www.instagram.com/kaluga_state_university/',
    vk: 'https://vk.com/club26957046',
  };

  return (
    <div>
      <IconButton  component="a" href={socialLinks.telegram} target="_blank" rel="noopener noreferrer">
      ...
      <IconButton component="a" href={socialLinks.vk} target="_blank" rel="noopener noreferrer">
        <VK color="white"/>
      </IconButton>
    </div>
  );
